...
* File bug reports and feature requests in the `issue tracker
  <https://github.com/emcd/python-frigid/issues>`_. (Please try to avoid
  duplicate issues.)

* Fork the repository and submit `pull requests
  <https://github.com/emcd/python-frigid/pulls>`_ to improve the library or
  its documentation.
...
.. automodule:: frigid._annotations


Module ``frigid._docstrings``
-------------------------------------------------------------------------------

.. automodule:: frigid._docstrings
   :ignore-module-all: true
